...
namespace Playwright_SpecFlow.Features
{
    ...
    public partial class RabbitMQProducerAndConsumerTestsFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "RabbitMQ Producer and Consumer Tests", null, global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line 5
    await testRunner.GivenAsync("a RabbitMQ producer is running", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 6
    await testRunner.WhenAsync("the producer send a simple message", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 7
    await testRunner.ThenAsync("the consumer should receive a message with the same content and structure", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
...
#line hidden
#line 11
    await testRunner.WhenAsync("the producer sends a complex message\'", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 12
    await testRunner.ThenAsync("the consumer should receive a message with the same content and structure", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
...
#line hidden
#line 16
    await testRunner.WhenAsync("the producer sends a list message\'", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 17
    await testRunner.ThenAsync("the consumer should receive a message with the same content and structure", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
